...
const footerThemes: Record<FooterTheme, {
  footerClass: string;
...
export default function Footer({ theme = 'default' }: FooterProps) {
  ...
  return (
    <footer className={`py-8 relative overflow-hidden ${themeConfig.footerClass}`} style={{ color: themeConfig.textColor }}>
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className='flex gap-2 items-center mb-4'>
              <h3 className="font-semibold text-lg" style={{ color: themeConfig.headingTextColor }}>
                US
              </h3>
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col items-start ">
                  <p className="flex gap-2 text-sm mb-1" style={{ color: themeConfig.textColor }}><svg className="w-4 h-4 mt-1 flex-shrink-0" fill="none" color={themeConfig.iconColor} stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg> 117 S LEXINGTON Harrisonville, MO US</p>
                <p className="flex gap-2  text-sm py-2"><svg className="w-4 h-4 flex-shrink-0" fill="none" color={themeConfig.iconColor} stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg> +61469021387</p>
                <p className='flex gap-2  text-sm'><svg className="w-4 h-4 flex-shrink-0" fill="none" color={themeConfig.iconColor} stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col items-start ">
                <p className="flex gap-2  text-sm mb-1"><svg className="w-4 h-4 mt-1 flex-shrink-0" fill="none" color={themeConfig.iconColor} stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg> RCTA 9059, Al Wizarat, Riyadh, Saudi Arabia
                </p>
                <p className="flex gap-2  text-sm py-2"><svg className="w-4 h-4 flex-shrink-0" fill="none" color={themeConfig.iconColor} stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg> +61469021387
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col items-start ">
                <p className="flex gap-2  text-sm mb-1"><svg className="w-4 h-4 mt-1 flex-shrink-0" fill="none" color={themeConfig.iconColor} stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg> 746 G4 Johar Town Lahore. Pakistan
                </p>
                <p className="flex gap-2  text-sm py-2"><svg className="w-4 h-4 flex-shrink-0" fill="none" color={themeConfig.iconColor} stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg> +923316663335 
            ...
            <div className="space-y-3">
              ...
              <div className="flex flex-col items-start ">
                <p className="flex gap-2  text-sm mb-1"><svg className="w-4 h-4 mt-1 flex-shrink-0" fill="none" color={themeConfig.iconColor} stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                  </svg> Mill St E, Dewsbury, WF12 9AQ, England, GB UK
                </p>
                <p className="flex gap-2  text-sm py-2"><svg className="w-4 h-4 flex-shrink-0" fill="none" color={themeConfig.iconColor} stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg> +61469021387
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-red-500/20">
          <p className="text-sm mb-4 md:mb-0" style={{ color: themeConfig.textColor }}>
            Copyright © 2024 CodeXpace. All rights reserved.
          </p>
          <div className="flex items-center space-x-4">
            <a href="https://www.facebook.com/share/1HDKEeNsrB/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center transition-colors" style={{ backgroundColor: themeConfig.socialBgColor, borderColor: themeConfig.socialBorderColor }}>
            ...
            <a href="https://www.instagram.com/codexpaceofficial?igsh=cHd5bHhjODI4NjE5" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center transition-colors" style={{ backgroundColor: themeConfig.socialBgColor, borderColor: themeConfig.socialBorderColor }}>
            ...
            <a href="https://www.linkedin.com/company/codexpaceofficial" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center transition-colors" style={{ backgroundColor: themeConfig.socialBgColor, borderColor: themeConfig.socialBorderColor }}>
